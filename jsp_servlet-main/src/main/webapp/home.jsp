...
<body>
	...
	<div class="container">
		...
		<form action="home" method="get">
			<input type="hidden" name="searchMode" value="followStats"> <label>Theo
				dõi tối thiểu:</label> <input type="number" name="minFollowing" min="0"
				value="3"> <label>Người theo dõi tối thiểu:</label> <input
				type="number" name="minFollowers" min="0" value="5">
		...
		<div class="pagination">
			<c:if test="${currentPage > 1}">
				<a href="?page=${currentPage - 1}" class="page-link">&laquo;
					Trước</a>
			</c:if>
